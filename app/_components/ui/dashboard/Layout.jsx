...
const Layout = ({ children }) => {
  return (
    ...
    <div className="bg-dash-back dark:bg-fill-900 min-h-dvh w-full transition-all duration-200">
      <aside className="fixed top-0 start-0 h-dvh w-56 bg-dash-fore shadow-lg dark:shadow-transparent overflow-scroll no-scrollbar transition-all duration-200">
